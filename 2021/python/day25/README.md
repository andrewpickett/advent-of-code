# Approach
### Part 1
> _What is the first step on which no sea cucumbers move?_

Really straightforward approach here: Go through the input and store the points of all east and south cucumbers
separately. Then move all of the east that are able by just increasing their column number by 1 and modding by the
size of the floor (effectively wrapping them around if they're at the end).

Keep track of if any of them moved during that step.

Then do the same thing for the south facing cucumbers

Keep track of if any of them moved as well.

If there was no movement, then that means you're done and you just return the iteration number.

### Part 2
> __

Oh, thank God...this year was just like previous years where if you have 49 stars, you automatically get the 50th.

Nothing to do but click the link to collect the star.

It is over...It is done. Good night.
...
|--------------|-------:|---------:|----------------:|----------------------:|-----:|
| **Part One** |    563 |        1 |           31983 |              00:52:03 | 2383 |
| **Part Two** |    N/A |      N/A |             N/A |              00:00:00 | 1731 |
